...
Zgodnie z wytycznymi, nie użyto jeszcze Deep Learningu (sieci neuronowych). Całość opiera się na klasycznej wizji komputerowej (OpenCV) i prostym modelu uczenia maszynowego.
